...
type PageDocumentDataSlicesSlice = HeroSlice | WordListSlice | RichTextSlice;
...
export interface HeroSliceDefaultPrimary {
	 ...
	 * - **Placeholder**: H1 italics for gold text
...
/**
 * Item in *WordList → Default → Primary → Word List*
 */
export interface WordListSliceDefaultPrimaryWordListItem {
	/**
	 * Word field in *WordList → Default → Primary → Word List*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: word_list.default.primary.word_list[].word
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
...
export interface WordListSliceDefaultPrimary {
	/**
	 * Word List field in *WordList → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: word_list.default.primary.word_list[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	word_list: prismic.GroupField<Simplify<WordListSliceDefaultPrimaryWordListItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			WordListSlice,
			WordListSliceDefaultPrimaryWordListItem,
